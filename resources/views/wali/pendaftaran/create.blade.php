    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-emerald-800 leading-tight">
                {{ __('Formulir Pendaftaran Santri') }}
            </h2>
            <a href="{{ route('dashboard') }}" class="bg-gray-600 hover:bg-gray-700 text-white font-medium py-2 px-4 rounded-lg transition duration-200 flex items-center gap-2">
                        ...
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                <p class="text-sm text-emerald-700">
                                    Pastikan semua data yang diisi sudah benar. Setelah dikirim, data akan diverifikasi oleh admin.
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    <input type="file" name="bukti_pembayaran" accept="image/*,.pdf" 
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition duration-200 @error('bukti_pembayaran') border-red-500 @enderror">
                                    <p class="mt-1 text-xs text-gray-500">Format: JPEG, PNG, JPG, PDF. Maksimal 2MB</p>
